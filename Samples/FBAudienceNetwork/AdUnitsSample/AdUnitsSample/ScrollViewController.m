...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id <UIViewControllerTransitionCoordinator>)coordinator
{
    ...
    // Reset scrollview frame to account for orientation changes,
    // we only want to adjust the width and leave the height untouched.
    CGRect newFrame = {
        self.scrollView.frame.origin,
        CGSizeMake( size.width, self.scrollView.frame.size.height)
    };
